...
rem    
rem    $Revision: 1.1.8.1 $  $Date: 2011/12/16 15:12:30 $
rem
rem ********************************************************************
...
set LIB=%IFORT_COMPILER12%\compiler\Lib\ia32;%VCINSTALLDIR%\ATLMFC\LIB;%VCINSTALLDIR%\LIB;%WINDOWSSDKDIR%\lib;%VSINSTALLDIR%\SDK\v3.5\lib;%MATLAB%\extern\lib\win32;%LIB%
