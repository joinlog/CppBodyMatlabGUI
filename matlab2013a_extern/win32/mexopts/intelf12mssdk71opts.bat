...
rem
rem    $Revision: 1.1.6.4 $  $Date: 2012/07/23 18:50:21 $
rem
rem ********************************************************************
...
set INCLUDE=%IFORT_COMPILER12%\compiler\Include;%LINKERDIR%\include;%VCINSTALLDIR%\ATLMFC\INCLUDE;%VCINSTALLDIR%\INCLUDE;%INCLUDE%
