...
rem
rem    $Revision: 1.1.6.1 $  $Date: 2012/09/25 18:19:54 $
rem
rem ********************************************************************
...
set INCLUDE=%IFORT_COMPILER13%\compiler\Include;%LINKERDIR%\include;%VCINSTALLDIR%\ATLMFC\INCLUDE;%VCINSTALLDIR%\INCLUDE;%INCLUDE%
