...
rem    2012 SP1 Professional Edition linker.
rem
...
rem
rem    $Revision: 1.1.6.1 $  $Date: 2012/09/25 18:20:00 $
rem
rem ********************************************************************
...
set INCLUDE=%IFORT_COMPILER13%\compiler\Include;%VCINSTALLDIR%\ATLMFC\INCLUDE;%VCINSTALLDIR%\INCLUDE;%LINKERDIR%\include\um;%LINKERDIR%\include\shared;%LINKERDIR%\include\winrt;%INCLUDE%
