...
rem C++keyLanguage: C++
rem C++keyLinkerName: Open WATCOM C/C++
rem C++keyLinkerVersion: 1.8
rem 
rem    $Revision: 1.1.6.6 $  $Date: 2012/07/23 18:50:30 $
rem
rem ********************************************************************
...
rem ********************************************************************
set COMPILER=wcl386
set COMPFLAGS=-c -bd -5s -e25 -ei -fpi87 -zq -fr# -DMATLAB_MEX_FILE
